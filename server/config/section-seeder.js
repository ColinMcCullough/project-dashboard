...
module.exports = [
  ...
  },
  {
    ...
    },
    {
      ...
      settings: {
        initialValue: null,
        mappedFields: { default: ['community_amenity_1', 'community_amenity_2', 'community_amenity_3'] },
        options: {
          MF: [
    ...
    fields: [
      {
        ...
        settings: {
          initialValue: null,
          mappedFields: { default: ['property_feature_1', 'property_feature_2', 'property_feature_3, property_feature_4'] },
          options: {
            default: [
